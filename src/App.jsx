...
import coffee4 from "./assets/images/latte.mp4";
        ...
        <table className="menu-table">
          <tbody>
            <tr className="upper-tr">
              ...
              {/* Hand Drip */}
              <td width={"30%"} className="coffee-bg">
                <section className="category brewing">
                  <h2>Hand Drip</h2>
                  <div className="item" onClick={() => open("brewing1", brewing1)}>
                    <span className="name">에티오피아 코스타리카 피치 오렌지 워시드<br /><span className="handDrip-exp">복숭아 · 오렌지 · 밀크초콜릿 · 리치 · <span className="important">강한산미</span></span></span>
                  ...
                  <div className="item" onClick={() => open("brewing4", brewing4)}>
              ...
              <td>
                <section className="category season">
                  <h2>Signiture</h2>
                  <div className="item" onClick={() => open("season1", Signiture1)}>
                    <span className="name">김천 호두크림 카페라떼</span>
                    <span className="price">5.7</span>
                  </div>
                  <div className="item" onClick={() => open("season3", Signiture3)}>
                    <span className="name">김천 말차크림 호두라떼</span>
                    <span className="price">6.0</span>
                  </div>
                  <div className="item" onClick={() => open("season4", Signiture4)}>
                    <span className="name">김천 호두 홍시라떼</span>
                    <span className="price">6.5</span>
                  </div>
                  <br />
                  <div className="item" onClick={() => open("season4", Signiture5)}>
                    <span className="name">김천 자두 캔디샷</span>
                    <span className="price">5.5</span>
                  </div>
                  <div className="item" onClick={() => open("season4", Signiture6)}>
              ...
              <td>
                <section className="category kids">
                  ...
                  <div className="item" onClick={() => open("kids1", kids1)}>
                    <span className="name">딸기라떼</span>
                    <span className="price">5.5</span>
                  </div>

                  <div className="item" onClick={() => open("kids1", kids1)}>
                    <span className="name">쑥딸기라떼</span>
                    <span className="price">5.5</span>
                  </div>
                  ...
                  <div className="item" onClick={() => open("kids5", kids5)}>
                    <span className="name">복숭아 아이스티</span>
              ...
              <td>
                <section className="category season">
                  ...
                  <div className="item" onClick={() => open("season5", Milktea1)}>
                    <span className="name">스리랑카 로얄 밀크티<br />(입문자용)</span>
                    <span className="price">5.5</span>
                  </div>

                  <div className="item" onClick={() => open("season6", Milktea2)}>
                    <span className="name">런던 얼그레이 냉침 밀크티<br />(베르가못 향이 진해요!)</span>
                    <span className="price">5.0</span>
                  </div>

                  <div className="item" onClick={() => open("coffee10", coffee10)}>
                    <span className="name">제주 말차라떼</span>
                    <span className="price">4.5</span>
                  </div>

                  <div className="item" onClick={() => open("coffee10", coffee10)}>
                    <span className="name">복숭아 제주 말차라떼</span>
                    <span className="price">5.0</span>
                  </div>
                </section>
              </td>
            ...
            <tr>
              {/* ESPRESSO */}
              <td className="items-cell coffee-bg">
                <section className="category espresso">
                  ...
                  <div className="item" onClick={() => open("coffee3", coffee3)}>
                    <span className="name">샤케라또</span>
                    <span className="price">4.0</span>
                  </div>

                  <div className="item" onClick={() => open("coffee4", coffee4, "video")}>
              ...
              <td>
                ...
                <section className="category tea">
                  <h2>Herb Tea</h2>
                  <div className="item" onClick={() => open("tea1", Herbtea1)}>
                    <span className="name">캐모마일 티<br />(non-sweet)</span>
                    <span className="price">4.5</span>
                  </div>
                  <div className="item" onClick={() => open("tea2", Herbtea2)}>
                    <span className="name">오렌지 루이보스 티<br />(non-sweet)</span>
                    <span className="price">4.5</span>
                  </div>
                  <div className="item" onClick={() => open("tea3", Herbtea3)}>
                    <span className="name">청귤 캐모마일 티</span>
                    <span className="price">5.0</span>
                  </div>
                  <div className="item" onClick={() => open("tea4", Herbtea4)}>
                    <span className="name">리치 캐모마일 티</span>
                    <span className="price">5.0</span>
                  </div>
                  <div className="item" onClick={() => open("tea5", Herbtea5)}>
              ...
              <td>
                <section className="category season">
                  ...
                  <div className="item" onClick={() => open("tea1", Blacktea1)}>
                    <span className="name">레몬 오렌지 블랙티<br />(non-sweet)</span>
                    <span className="price">4.5</span>
                  </div>
                  <div className="item" onClick={() => open("tea2", Blacktea2)}>
                    <span className="name">레몬 얼그레이 블랙티</span>
                    <span className="price">5.0</span>
                  </div>
                  <div className="item" onClick={() => open("tea3", Blacktea3)}>
                    <span className="name">자몽청 허니 블랙티</span>
                    <span className="price">5.0</span>
                  </div>
                  <div className="item" onClick={() => open("tea4", Blacktea4)}>
